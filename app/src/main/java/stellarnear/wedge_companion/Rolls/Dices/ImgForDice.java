...
public class ImgForDice {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(mA)
                        ...
                        .setMessage("Ressources :\n\n" +
                                "Point(s) mythique restant(s) : "+wedge.getResourceValue("resource_mythic_points")+"\n" +
                                "Point(s) légendaire restant(s) : "+wedge.getResourceValue("resource_legendary_points"))
    ...
    private void launchingMythicDice(String mode) {
        ...
        if(mode.equalsIgnoreCase("légendaire")){
            points = MainActivity.wedge.getResourceValue("resource_legendary_points");
        } else {
            points = MainActivity.wedge.getResourceValue("resource_mythic_points");
        }
