...
public class MainActivityFragmentCombat extends Fragment {
    ...
    private void hideButtons(int buttonClicked) {
        ...
        FrameLayout frame = mainPage.findViewById(R.id.leg_pts);
        frame.animate().translationXBy(200).setDuration(1000).start();
        FrameLayout frame2 = mainPage.findViewById(R.id.mythic_pts);
    ...
    private void setListenerFabDmg() {
        fabDmg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FloatingActionButton fab_dmg = (FloatingActionButton) mainPage.findViewById(R.id.fab_damage);
