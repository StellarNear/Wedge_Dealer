...
public class Perso {
    ...
    private AllAdditionalsInfos allInfos;
    ...
    public Perso(Context mC, String pjID) {
        ...
        allInfos = new AllAdditionalsInfos(mC, pjID);
        ...
        allAbilities = new AllAbilities(mC, inventory, allCapacities, pjID);
    ...
    public AllAdditionalsInfos getAllInfos() {
        return allInfos;
    }
    ...
    public Integer getSkillBonus(String skillId) {
        ...
        if ((skillId.equalsIgnoreCase("skill_nature") || skillId.equalsIgnoreCase("skill_geo")) && getAllCapacities().capacityIsActive("capacity_green_faith")) {
            bonusTemp += 1;
        }
        if ((skillId.equalsIgnoreCase("skill_heal") || skillId.equalsIgnoreCase("skill_plan")) && getAllCapacities().capacityIsActive("capacity_aasimar_ascent")) {
            bonusTemp += 2;
        }
        return bonusTemp;
    }
    ...
    public Integer getAbilityScore(String abiId) {
        ...
        if (allAbilities.getAbi(abiId) != null) {
            ...
            if (abiId.equalsIgnoreCase("ability_ca")) {
                ...
                if (pjID.equalsIgnoreCase("sylphe") || pjID.equalsIgnoreCase("rana")) {
                    ...
                    if (allFeats.featIsActive("feat_natural_armor_up")) {
                        abiScore += 1;
                    }
                }
            ...
            } else if (abiId.equalsIgnoreCase("ability_info")) {
                abiScore = allInfos.getListInfos().size();
                ...
                if (bonusRmGlobal > abiScore) {
                    abiScore = bonusRmGlobal;
                }
        ...
        if (allForms != null && allForms.hasActiveForm()) {
            abiScore += allForms.getFormAbilityModif(abiId);
        }
        return abiScore;
    }
            ...
            if (tools.toInt(cap.getDailyUseString()) == 0) {
                ...
                switch (cap.getDailyUseString()) {
                    ...
                    case "(lvl_druid/2)-1+lvl_archer/3":
                        dailyUse = druidLvl / 2 - 1 + archerLvl / 3;
                        break;
                    case "1+((lvl_archer-6)/4)":
                        dailyUse = 1 + (archerLvl - 6) / 4;
                        break;
                    case "1+((lvl_archer-8)/3)":
                        dailyUse = 1 + (archerLvl - 8) / 3;
                        break;
