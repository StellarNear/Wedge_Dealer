...
public class PrefXpFragment {
    ...
    public void checkLevel(BigInteger currentXp, BigInteger... addXpInput) {
        ...
        String[] listLvlXp = mC.getResources().getStringArray(R.array.xp_lvl_needed);
        ...
        for (String line : listLvlXp) {
            ...
            listXp.add(tools.toBigInt(line.substring(line.indexOf(":") + 1)));
        }
        ...
        if (newLvl > currentLvl) {
            ...
            tools.customToast(mC, "Bravo tu as atteint le niveau " + newLvl);
        }
    }
