...
public class ElemsManager {
    ...
    public ElemsManager(Context mC){
        ...
        listElems.add(new Elem("none","aucun",mC.getColor(R.color.phy),mC.getColor(R.color.recent_phy)));
        ...
        listElems.add(new Elem("heal","soin",mC.getColor(R.color.colorPrimaryhalda),mC.getColor(R.color.colorPrimaryDarkhalda)));
    }
