...
public class AttacksElemsManager {
    private Context mC;
    private static AttacksElemsManager instance;

    private List<Elem> listElems;

    public AttacksElemsManager(Context mC){
    ...
    public static AttacksElemsManager getInstance(Context context) {
        if (instance==null){instance=new AttacksElemsManager(context);}
        return instance;
    }

    public static AttacksElemsManager getInstance() {
        return instance;
    }
